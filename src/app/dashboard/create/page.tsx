      ...
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-2xl p-8 border border-blue-100">
        ...
        <div className="flex justify-between items-center mb-8">
          {[
            ...
            { label: "Classify", icon: <Loader2 className={`w-5 h-5${step === 2 && uploading ? ' animate-spin' : ''}`} /> },
        ...
        {step === 2 && uploading && (
          <div className="flex flex-col items-center justify-center py-16 animate-fade-in">
            ...
            <div className="text-xl font-bold text-blue-700 mb-2 text-center">Image classification is taking place with the power of AI.</div>
            <div className="text-blue-500 text-center">Hang on...</div>
          </div>
        )}
        ...
        {step === 3 && (
          <div className="bg-blue-50 rounded-xl p-6 shadow-inner mb-6 animate-fade-in">
            ...
            <div className="mb-4">
              <label className="block font-medium mb-1 text-blue-800">Image Name:</label>
              <input
                type="text"
